...
<form action="<?php echo e(route('farmer.create')); ?>" method="POST" id="kt_modal_create_app_form">
    <?php echo csrf_field(); ?>
                                ...
                                success: function(response) {
                                    ...
                                    if (response.flag === 'success') {
                                        ...
                                        Swal.fire({
                                            ...
                                            window.location.href = "<?php echo e(url('farmer')); ?>";
                                        });
                                    } else {
...
<?php /**PATH /home/u931094414/domains/royalblue-stinkbug-731974.hostingersite.com/public_html/resources/views/farmers/create.blade.php ENDPATH**/ ?>