                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between w-100">
                                    ...
                                    <a href="#" data-url="<?php echo e(route('permissions.create')); ?>"
                                        ...
                                        data-ajax-popup="true"   data-title="<?php echo e(__('Add Permission')); ?>"
                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="<?php echo e(__('Add Permission')); ?>">
                                                    ...
                                                    <table class="table table-striped dataTable">
                                                        <thead class="">
                                                            <tr>
                                                                ...
                                                                <th scope="col" style="width: 12%;"><?php echo e(__('Action')); ?>
                                                                ...
                                                                <tr role="row">
                                                                    ...
                                                                    <td>
                                                                        <a href="#"
                                                                            ...
                                                                            data-title="<?php echo e(__('Update permission')); ?>"  data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                                            title="<?php echo e(__('Edit')); ?>"
                                                                            class="btn btn-sm btn-icon  bg-light-secondary me-2">
                                                                            <i class="far fa-edit"></i>
                                                                        </a>
                                                                        <a href="#" class="bs-pass-para btn btn-sm btn-icon bg-light-secondary"
                                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dismas/Desktop/fe/resources/views/permission/index.blade.php ENDPATH**/ ?>