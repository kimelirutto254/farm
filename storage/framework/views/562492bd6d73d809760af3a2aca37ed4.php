...
<div class="modal-footer pr-0">
    <button type="button" class="btn dark btn-outline" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
    <?php echo e(Form::submit(__('Create'),array('class'=>'btn btn-primary'))); ?>

</div>
<?php echo e(Form::close()); ?>

<?php /**PATH /Users/dismas/Desktop/fe/resources/views/permission/create.blade.php ENDPATH**/ ?>