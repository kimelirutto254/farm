                                                                                                            ...
                                                                                                            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                                                                                                                ...
                                                                                                                <thead>
                                                                                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                                                                        ...
                                                                                                                        <th class="text-end pe-3 min-w-100px">Non-Compliance</th>
                                                                                                                        <th class="text-end pe-3 min-w-150px">Timeframe</th>
                                                                                                                        <th class="text-end pe-3 min-w-100px">Follow Up</th>
                                                                                                                ...
                                                                                                                <tbody class="fw-bold text-black">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td class="text-end"><?php echo e($nonCompliance->requirement); ?></td>
                                                                                                                        <td class="text-end"><?php echo e($nonCompliance->timeline); ?></td>
                                                                                                                        <td class="text-end"><?php echo e($nonCompliance->followup_date); ?></td>
                                                                                                                        <td class="text-end">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931094414/domains/royalblue-stinkbug-731974.hostingersite.com/public_html/resources/views/farmers/show_inspection.blade.php ENDPATH**/ ?>