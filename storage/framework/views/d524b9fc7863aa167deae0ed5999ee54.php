                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body pt-6">
                        <form id="kt_account_profile_details_form" class="form" action="" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?> <!-- Include this Blade directive for CSRF protection -->
                            <div class="card-body border-top p-9">
                                <div class="row mb-6">
                                    <div class="col-lg-4">
                                        <label class="col-form-label required fw-semibold fs-6">Company Name</label>
                                        <input type="text" name="company_name" class="form-control form-control-lg form-control-solid" placeholder="Company name" value="<?php echo e($company_settings->name); ?>" />
                                    </div>
                                   
                                    <div class="col-lg-4">
                                        <label class="col-form-label fw-semibold fs-6">Company Address</label>
                                        <input type="text" name="company_address" class="form-control form-control-lg form-control-solid" placeholder="Company address" value="<?php echo e($company_settings->location); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="email" name="company_email" class="form-control form-control-lg form-control-solid" placeholder="Company email" value="<?php echo e($company_settings->email); ?>" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="col-form-label fw-semibold fs-6">Company Manager</label>
                                        <input type="text" name="company_manager" class="form-control form-control-lg form-control-solid" placeholder="Company manager" <?php echo e($company_settings->manager); ?> />
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="col-form-label fw-semibold fs-6">KML Urls</label>
                                        <input type="text" name="kml_urls" class="form-control form-control-lg form-control-solid" placeholder="KML URLs" <?php echo e($company_settings->name); ?> />
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931094414/domains/royalblue-stinkbug-731974.hostingersite.com/public_html/resources/views/settings/index.blade.php ENDPATH**/ ?>