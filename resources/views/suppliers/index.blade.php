            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <a {{ route('suppliers.export') }} class="btn btn-light-primary me-3">
                            <i class="ki-duotone ki-exit-up fs-2">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>Export
                        </a>
                        <button type="button" class="btn btn-primary"data-url="{{ route('suppliers.create') }}" data-ajax-popup="true" data-title="{{__('Add New Supplier')}}" data-size="md" title="{{__('Add Supplier')}}" data-bs-toggle="tooltip" data-bs-placement="top">Add Supplier</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ \Auth::user()->dateFormat($supplier->created_at) }}</td>
                                            ...
                                            <a href="#" class="btn btn-sm btn-primary btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('suppliers.edit', \Illuminate\Support\Facades\Crypt::encrypt($supplier->id)) }}" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Edit</a>
                                                    </div>
                                                    @endcan
                                                    @can('Delete Suppliers')                                                   
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('suppliers.delete', \Illuminate\Support\Facades\Crypt::encrypt($supplier->id)) }}" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
                                                    </div>
                                                    @endcan
                                                </div>
                                            </td>                                        
