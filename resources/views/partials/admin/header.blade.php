...
<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex align-items-center flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->  <a href="{{url('')}}" class="app-sidebar-logo">
                <img alt="Logo" src="{{asset('landing/logo.png')}}" class="h-70px bg-white theme-light-show app-sidebar-logo" />
            </a>
            ...
            <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">
                                    ...
                                    <span
                                        class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ Auth::user()->plan }}!</span>
                                </div>
                                <a href="#"
                    ...
                    <div class="menu-item px-5 my-1">
                        <a href="{{route('settings')}}" class="menu-link px-5">Company Settings</a>
                    </div>
...
<script>
    document.getElementById('pageSelect').addEventListener('change', function() {
        if (this.value === 'create_new_store') {
            ...
            window.location.href = "{{ route('company-resource.create') }}"; // Redirect to create new store URL
        }
    });
</script>