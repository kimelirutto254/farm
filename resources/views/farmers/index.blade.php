            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-tooFlbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <a href="{{ route('farmers.export') }}" class="btn btn-light-primary me-3 ">
                        ...
                        <button type="button" class="btn btn-primary"data-url="{{ route('farmers.import') }}" data-ajax-popup="true" data-title="{{__('Upload Farmers')}}" data-size="md" title="{{__('Upload Farmer')}}" data-bs-toggle="tooltip" data-bs-placement="top"> <i class="ki-duotone ki-exit-up fs-2">
                            <span class="path1"></span>
                            <span class="path2"></span>
                        </i></button>
                        <button type="button" class="btn btn-primary"data-url="{{ route('farmer.create') }}" data-ajax-popup="true" data-title="{{__('Add New Farmer')}}" data-size="lg" title="{{__('Add Farmer')}}" data-bs-toggle="tooltip" data-bs-placement="top">Add Farmer</button>
                            ...
                            <table class="table table-rounded table-striped border gy-7 gs-10" id="example">
                                <thead>
                                    <tr class="fw-semibold bg-primary  fs-6 text-white border-bottom border-gray-200">
                                        ...
                                        @if (Gate::check('Edit Farmers') || Gate::check('Delete Farmers'))
