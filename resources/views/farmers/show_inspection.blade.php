            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('no-farm-polygon', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-danger ms-3 px-4 py-3">No Farm Polygon</a>
                        <a href="{{ route('no-center-coordinate', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-warning ms-3 px-4 py-3">No Center Coordinate</a>
                        <a href="{{ route('continuous-improvement', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-primary ms-3 px-4 py-3">Continuous Improvement</a>
                        <a href="{{ route('approve', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-success ms-3 px-4 py-3">Approve</a>
                        <a href="{{ route('reject', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-danger ms-3 px-4 py-3">Reject</a>
                        <a href="{{ route('edit-checklist', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-secondary ms-3 px-4 py-3">Edit Checklist</a>
                        <a href="{{ route('download-report', \Illuminate\Support\Facades\Crypt::encrypt($farmer->id)) }}" class="btn btn-sm btn-primary ms-3 px-4 py-3">Download Report</a>
                    </div>
                </div>
            </div>
        </div>
                                                                                                ...
                                                                                                <div class="card-body">
                                                                                                    ...
                                                                                                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                                                                                                        ...
                                                                                                        <tbody class="fw-bold text-black">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>{{ $nonCompliance->code }}</td>
                                                                                                                <td class="">{{ $nonCompliance->requirement }}</td>
                                                                                                                <td class="">{{ $nonCompliance->timeline }}</td>
                                                                                                                <td class="">{{ $nonCompliance->followup_date }}</td>
                                                                                                                <td class="">
                                                                                                                    <span class="badge py-3 px-4 fs-7 badge-light-primary">{{ $nonCompliance->status }}</span>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            @endforeach
                                                                                                        </tbody>
                                                                                            ...
                                                                                            <script>
                                                                                                document.addEventListener('DOMContentLoaded', function() {
                                                                                                    ...
                                                                                                    map.on('load', function() {
                                                                                                        ...
                                                                                                        var polygons = [
                                                                                                        {
                                                                                                            coordinates: parsePolygon('{{ $farmAreaPolygons }}'),
                                                                                                            color: '#FF0000',
                                                                                                            label: 'Farm Area'
                                                                                                        },
                                                                                                        {
                                                                                                            coordinates: parsePolygon('{{ $cropAreaPolygons }}'),
                                                                                                            color: '#00FF00',
                                                                                                            label: 'Crop Area'
                                                                                                        },
                                                                                                        {
                                                                                                            coordinates: parsePolygon('{{ $conservationAreaPolygons }}'),
                                                                                                            color: '#0000FF',
                                                                                                            label: 'Conservation Area'
                                                                                                        },
                                                                                                        {
                                                                                                            coordinates: parsePolygon('{{ $otherCropsAreaPolygons }}'),
                                                                                                            color: '#FFFF00',
                                                                                                            label: 'Other Crops Area'
                                                                                                        },
                                                                                                        {
                                                                                                            coordinates: parsePolygon('{{ $residentialAreaPolygons }}'),
                                                                                                            color: '#FFA500',
